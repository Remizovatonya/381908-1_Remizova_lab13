...
TSquare::TSquare(const TLine& _l1, const TLine& _l2, const TLine& _l3, const TLine& _l4) : l1(_l1), l2(_l2), l3(_l3), l4(_l4)
{

}

TSquare::TSquare(const TSquare& _square) : l1(_square.l1), l2(_square.l2), l3(_square.l3), l4(_square.l4)
{
}
...
double TSquare::SetVal(double val, int i)
{
    switch (i / 4) {
    case 0:
        l1.SetVal(val, 0);
